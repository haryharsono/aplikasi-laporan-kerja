            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="nama" class="form-control" value="{{$data->nama_pelaksana}}" placeholder="Masukkan Nama" required>
                      </div>
                      <div class="form-group">
                        <div class="form-group">
                            <label for="exampleInputEmail1">Sasaran Kerja</label>
                            <input type="text" name="sasaran_kerja" value="{{$data->sasaran_kerja}}" class="form-control" placeholder="Masukkan Sasaran Kerja" required>
                          </div>
                    </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Uraian Kerja" name="uraian_kerja" value="{{$data->uraian_kerja}}" required>
                      </div>
                </div>
              ...
              <div class="col-md-6">
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="jumlah_pengeluaran" value="{{$data->jumlah_output_hasil}}" required>
                ...
                <div class="form-group">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" placeholder="Masukkan Kendala" name="kendala" value="{{$data->kendala}}" required>
                      </div>
                </div>
                <div class="form-group">
